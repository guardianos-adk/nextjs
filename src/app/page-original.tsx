          ...
          >
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                ...
                >
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="guardian-body text-muted-foreground">
                        Institutions deposit funds into smart contract pools where transactions are 
                        <span className="guardian-emphasis"> private by default</span>, using 
                        <span className="guardian-emphasis"> zero-knowledge proofs</span> to maintain anonymity.
                      </p>
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h4 className="guardian-heading-4 mb-2">AI-Powered Monitoring</h4>
                      <p className="guardian-body text-muted-foreground">
                        <span className="guardian-emphasis">Google ADK-powered agents</span> continuously monitor all transactions for 
                        suspicious patterns, using <span className="guardian-emphasis">advanced risk scoring algorithms</span> without 
                ...
                >
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h4 className="guardian-heading-4 mb-2">Guardian Consensus for Compliance</h4>
                      <p className="guardian-body text-muted-foreground">
                        When suspicious activity is detected, a network of <span className="guardian-emphasis">5 independent guardians</span> from 
                        different jurisdictions vote on whether to reveal transaction details. 
                        <span className="guardian-emphasis"> 3 of 5 must approve</span>.
                      </p>
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h4 className="guardian-heading-4 mb-2">Selective Disclosure</h4>
                      <p className="guardian-body text-muted-foreground">
                        Only the <span className="guardian-emphasis">specific transaction under investigation</span> is 
                        revealed to authorities. All other users maintain 
                        <span className="guardian-emphasis"> complete privacy</span>, protecting innocent parties.
                      </p>
                    </div>
                  </div>
                </motion.div>
              ...
              <div className="relative">
                <div className="guardian-card p-8 bg-gradient-to-br from-slate-50 to-blue-50 dark:from-slate-900 dark:to-blue-950">
                  <div className="text-center mb-8">
                    <h3 className="guardian-heading-3 mb-2">Guardian Network</h3>
                    <p className="guardian-body text-muted-foreground">
                      <span className="guardian-emphasis">5 regulatory nodes</span> • 
                      <span className="guardian-emphasis"> 3-of-5 consensus</span>
                    </p>
                  </div>
